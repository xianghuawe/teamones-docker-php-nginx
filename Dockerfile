...
RUN apk update && \
    ...
    php7-zip php7-zlib php7-xml php7-phar php7-intl php7-dom php7-xmlreader php7-ctype php7-session php7-fileinfo php-tokenizer php-simplexml php7-xmlwriter php7-amqp\
