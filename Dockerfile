...
RUN apk update && \
    apk --no-cache add php7 php7-fpm php7-opcache php7-mysqli php7-pdo php7-pdo_mysql php7-pdo_sqlite php7-json php7-ftp php7-openssl php7-curl libevent-dev \
    ...
    php7-sockets php7-redis php7-bcmath php7-calendar php7-mbstring php7-gd php7-iconv php7-tokenizer php7-event php7-pcntl php7-posix supervisor curl tar tzdata
